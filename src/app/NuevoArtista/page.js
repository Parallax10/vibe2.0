...
<div>
    ...
    {/* === NUEVO ARTISTA === */}
    <div className="bg-fondoNavbar rounded shadow-md p-8 w-96">
    ...
    <div className="bg-fondoNavbar rounded shadow-md p-8 w-96">
        ...
        <div>
            ...
            <input
            type="text"
            value={cancionPortada}
            onChange={(e) => setCancionPortada(e.target.value)}
            className="w-full p-2 rounded border"
            />
        </div>
        ...
        <div>
            ...
            type="text"
            value={cancionNombre}
            onChange={(e) => setCancionNombre(e.target.value)}
            className="w-full p-2 rounded border"
            />
        </div>
        ...
        <div>
            ...
            type="text"
            value={cancionGenero}
            onChange={(e) => setCancionGenero(e.target.value)}
            className="w-full p-2 rounded border"
            />
        </div>
        <button
            onClick={validarCancion}
            className="mt-25.5 bg-green-600 text-white py-2 rounded hover:bg-green-700 transition"
        >
            Agregar canción
        </button>
        </div>
