...
export default function CardArtistas({ id, nombre, pais, genero, img, size = "small" }) { 

const cardSize =
size === "large"
    ? "w-48 h-80 p-4 text-sm sm:w-64 sm:h-80 sm:p-6 sm:text-base"
    : "w-32 h-64 p-3 text-xs sm:w-40 sm:p-4 sm:text-sm";
